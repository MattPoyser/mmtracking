_base_ = [
    '../../_base_/models/faster_rcnn_r50_fpn.py', '../../_base_/datasets/mot_challenge.py', '../../_base_/default_runtime.py']
...
model = dict(
    ...
    pretrains=dict(
        ...
        "/home2/lgfm95/drone/Strig-UAV-Project/bird-vs-drone/fasterrcnn/full/latest.pth",
        reid=  # noqa: E251
