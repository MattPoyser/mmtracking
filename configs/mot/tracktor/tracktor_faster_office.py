...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/data/drones/anti-uav/images/anti-uav-full.json',
        img_prefix='/data/drones/anti-uav/images/'
        # ann_file='data/strig-drones/datasets/mav-vid/train_annotations.json',
        ),
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/data/drones/anti-uav/images/anti-uav-test-full.json',
        img_prefix='/data/drones/anti-uav/images/'
        ))
model = dict(
    type='Tracktor',
    pretrains=dict(
        ...
        "/data/drones/Strig/fasterrcnn/full/latest.pth",
        reid=  # noqa: E251
